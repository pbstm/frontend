...
const CabinetHeader: React.FC = () => {
  ...
  return (
    <div className={classes.Header}>
      <Link to="sessions" spy smooth offset={-70} duration={500} className={classes.Card1}>
      ...
      <Link to="locations" spy smooth offset={-70} duration={500} className={classes.Card2}>
      ...
      <Link to="schedule" spy smooth offset={-70} duration={500} className={classes.Card3}>
      ...
      <Link to="accessories" spy smooth offset={-70} duration={500} className={classes.Card4}>
